...
if client.collection_exists(COLLECTION_NAME):
    ...
    print("\nOptions:")
    print("  1. Recreate collection (delete all data)")
    print("  2. Cancel and keep existing collection")
...
print("\nYou can now:")
print("  1. Run 'python test_embeddings.py' to verify")
print("  2. Run 'python dna_server.py' to start the server")
print("  3. Use 'sync_github_repo()' to re-index your repositories")

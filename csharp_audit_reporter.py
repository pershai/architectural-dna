...
class CSharpAuditReporter:
    ...
    def generate_json_report(
        ...
        try:
            ...
            raise ValueError(
                f"Cannot write report: permission denied at {output_path}"
            ) from e
    ...
    def generate_markdown_report(
        ...
        try:
            ...
            logger.error(
                f"Unexpected error generating markdown report: {e}", exc_info=True
            )
            raise
    ...
    def generate_sarif_report(result: AuditResult, output_path: str) -> dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                f"Unexpected error generating SARIF report: {e}", exc_info=True
            )
            raise

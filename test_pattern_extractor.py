...
"""
        ...
        if user_chunks:  # If AST succeeded
            ...
            assert "[Table" in user_chunks[0].content or "[Serializable" in user_chunks[0].content
...
"""
        ...
        assert any("IEntity" in c.name or "User" in c.name or "Product" in c.name for c in chunks)
